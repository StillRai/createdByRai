...
import lesson1Audio from '../../assets/audio/lesson1.mp3';
  ...
  return (
    <div className="p-8">
      <div className="flex justify-between items-center">
        ...
        <button onClick={() => toggleAudio(lesson1Audio)} className="audio-toggle-button">
          {isPlaying ? (
      ...
      <p className="mb-4">
        Take a moment to think about all the things you have stored online. Emails, bank details, maybe even embarrassing videos that you'd rather keep hidden away. A solid password is your first line of defense against digital criminals.
      </p>
      <p className="mb-4">
        ...
        <ul className="list-disc ml-6">
          ...
          <li><strong>Credential Stuffing:</strong> A type of cyber-attack where attackers use a list of known username and password combinations to gain unauthorized access to accounts.</li>
        </ul>
      </p>
      <p className="mb-4">
      ...
      <div className="flex justify-between mt-4">
                <button onClick={() => { stopAudio(); nextLesson(); }} className="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-700">
          Let's Keep Rolling!
        </button>
      </div>
    </div>
